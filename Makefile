...
all:
	...
	mkdir --parents $(PWD)/build/AppDir/pencil
	...
	cp --force --recursive $(PWD)/build/opt/pencil-*/* $(PWD)/build/AppDir/pencil
	...
	export ARCH=x86_64 && $(PWD)/bin/appimagetool.AppImage $(PWD)/build/AppDir $(PWD)/Pencil.AppImage
